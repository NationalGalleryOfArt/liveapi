...
class TestHandleNoCommand:
    ...
    def test_uninitialized_project_choice_1(self, mock_print, mock_input, mock_metadata):
        ...
        with patch('src.liveapi.cli.commands.project.cmd_init') as mock_init, \
             patch('src.liveapi.cli.commands.generate.cmd_generate') as mock_generate:
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_uninitialized_project_choice_2(self, mock_print, mock_input, mock_metadata):
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_uninitialized_project_choice_3(self, mock_print, mock_input, mock_metadata):
    ...
    @patch('builtins.print')
    def test_initialized_project_no_changes(self, mock_print, mock_change_detector, mock_metadata):
    ...
    @patch('src.liveapi.cli.commands.project.ChangeDetector')
    @patch('builtins.print')
    def test_initialized_project_with_changes(self, mock_print, mock_change_detector, mock_metadata):
        ...
        mock_detector = Mock()
        mock_detector.detect_all_changes.return_value = {"spec1.yaml": Mock(), "spec2.yaml": Mock()}
        mock_change_detector.return_value = mock_detector
...
class TestCmdInit:
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_successful_init_with_specs(self, mock_print, mock_input, mock_change_detector, mock_metadata):
        ...
        mock_detector = Mock()
        mock_detector.find_api_specs.return_value = [Path("api.yaml"), Path("users.yaml")]
        mock_change_detector.return_value = mock_detector
        ...
        mock_manager.initialize_project.assert_called_once_with("test-project", "api.example.com")
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_init_no_specs_found(self, mock_print, mock_input, mock_change_detector, mock_metadata):
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_init_keyboard_interrupt(self, mock_print, mock_input, mock_change_detector, mock_metadata):
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_init_url_with_protocol(self, mock_print, mock_input, mock_change_detector, mock_metadata):
...
class TestCmdStatus:
    ...
    def test_status_uninitialized(self, mock_print, mock_metadata):
        ...
        mock_print.assert_called_with("❌ Project not initialized. Run 'liveapi init' first.")
    ...
    @patch('src.liveapi.cli.commands.project.ChangeDetector')
    @patch('builtins.print')
    def test_status_with_breaking_changes(self, mock_print, mock_change_detector, mock_metadata):
    ...
    @patch('src.liveapi.cli.commands.project.ChangeDetector')
    @patch('sys.exit')
    def test_status_with_check_flag_breaking(self, mock_exit, mock_change_detector, mock_metadata):
    ...
    @patch('src.liveapi.cli.commands.project.ChangeDetector')
    @patch('sys.exit')
    def test_status_with_check_flag_non_breaking(self, mock_exit, mock_change_detector, mock_metadata):
