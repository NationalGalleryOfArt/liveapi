...
class TestSpecGenerator:
    ...
    def test_status_codes_by_method(self):
        ...
        assert (
            result["paths"]["/items"]["post"]["responses"]["201"]["description"]
            == "Created"
        )
        ...
        assert (
            result["paths"]["/items/{id}"]["delete"]["responses"]["204"]["description"]
            == "No Content"
        )
        ...
        assert (
            result["paths"]["/items"]["get"]["responses"]["200"]["description"]
            == "Success"
        )
        ...
        assert (
            result["paths"]["/items/{id}"]["put"]["responses"]["200"]["description"]
            == "Success"
        )
    ...
    def test_error_response_examples(self):
        ...
        assert (
            "example"
            in endpoint_responses["400"]["content"]["application/problem+json"]
        )
        bad_request_example = endpoint_responses["400"]["content"][
        ...
        assert (
            "example"
            in endpoint_responses["401"]["content"]["application/problem+json"]
        )
        unauthorized_example = endpoint_responses["401"]["content"][
            "application/problem+json"
        ]["example"]
        ...
        assert (
            "example"
            in endpoint_responses["500"]["content"]["application/problem+json"]
        )
        server_error_example = endpoint_responses["500"]["content"][
            "application/problem+json"
        ]["example"]
        ...
        assert (
            "example"
            in endpoint_responses["503"]["content"]["application/problem+json"]
        )
        unavailable_example = endpoint_responses["503"]["content"][
            "application/problem+json"
        ]["example"]
