...
'''
        ...
        create_response = client.post("/users_v1/users", json={
            "name": "John",
...
'''
        ...
        create_response = client.post("/users_v2/users", json={
            "full_name": "Jane Doe",
...
'''
        ...
        create_v1 = client.post("/users_v1/users", json={"name": "TestUser", "email": "test@example.com"})
        ...
        create_v2 = client.post("/users_v2/users", json={"full_name": "Jane Doe", "email": "jane@example.com", "phone": "+1234567890"})
