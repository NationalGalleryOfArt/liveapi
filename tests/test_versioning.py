...
class TestVersionedMethodCalls:
    ...
    def test_call_method_with_version_parameter(self):
        ...
        # Test version 2
        result = generator.call_method_with_version("create_user", {"full_name": "John Doe", "email": "john@example.com"}, 2)
    ...
    def test_version_aware_get_user(self):
        ...
        class TestImpl:
            def get_user(self, data, version=1):
                user_data = {"id": 1, "name": "John", "full_name": "John Doe", "email": "john@example.com"}
        ...
        expected_v2 = ({"user_id": 1, "full_name": "John Doe", "email": "john@example.com"}, 200)
        assert result == expected_v2
        
        # Test version 3
        result = impl.get_user({"user_id": 1}, version=3)
        expected_v3 = ({"user_id": 1, "profile": {"full_name": "John Doe", "email": "john@example.com"}}, 200)
