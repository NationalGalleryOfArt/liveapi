...
class BaseCrudImplementation(ABC):
    ...
    def index(
        self, filters: Optional[Dict] = None, auth_info: Optional[Dict] = None
    ) -> Tuple[List[Dict], int]:
        """
    ...
    def show(
        self, resource_id: str, auth_info: Optional[Dict] = None
    ) -> Tuple[Dict, int]:
        """
    ...
    def create(self, data: Dict, auth_info: Optional[Dict] = None) -> Tuple[Dict, int]:
        ...
        if resource_id in self.data_store:
            raise ConflictError(
                f"{self.resource_name.title()} with ID {resource_id} already exists"
            )
    ...
    def update(
        self, resource_id: str, data: Dict, auth_info: Optional[Dict] = None
    ) -> Tuple[Dict, int]:
        """
...
class BaseImplementation:
    ...
    async def get_data(
        self, resource_type: str, resource_id: str, auth_info: Optional[Dict] = None
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            # Placeholder external data fetch
            external_data = {
                "id": resource_id,
                "type": resource_type,
                "status": "active",
